...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment payment2=new Payment(new BigDecimal(120000), LocalDate.of(2022,3,17), Status.FAILURE);
        ...
        System.out.println(paymentRepository.findById(new BigDecimal(2)).get().getPaymentDetail().getCommissionAmount());
